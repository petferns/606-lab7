...
The data set has survey to find risky youth behavior based on whether they text or wear helmet during driving, hours they sleep, hours they watch tv, etc.
Total cases in this sample are - 13583
...
Total observations missing weights are 1004
...
The plots looks similar with almost same median

```{r}
boxplot(data = yrbss, weight~physical_3plus, col = 'grey')
```
...
As the sample size is large and assuming the samples are independent its a normal distribution
...
H<sub>0</sub> There is no difference in average weights among those who exercise at least a week and those who don't

H<sub>1</sub> There is difference in average weights among those who exercise at least a week and those who don't
